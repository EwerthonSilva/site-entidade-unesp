tinymce.ThemeManager.add("dbo", function (e) {
    function t() {
        function t(t) {
            var i, r = [];
            if (t) return m(t.split(/[ ,]/), function (t) {
                ...
                "|" == t ? i = null : u.has(t) ? (t = {
                    ...
                    type: "buttongroup",
                    items: []
                }, r.push(i)), e.buttons[t] && (a = t, t = e.buttons[a], "function" == typeof t && (t = t()), t.type = t.type || "button", c.toolbar_items_size && (t.size = c.toolbar_items_size), t = u.create(t), i.items.push(t), e.initialized ? n() : e.on("init", n)))
            }), n.push({
                type: "toolbar",
                layout: "flow",
                items: r
    ...
    function o() {
        ...
        function s() {
            ...
            }), m.renderTo(f || document.body).reflow(), i(m), a(), e.on("nodeChange", r), e.on("activate", a), e.on("deactivate", o), void 0)
        }
        var m, f;
    ...
    function s(a) {
        ...
        }), o.renderBefore(a.targetNode).reflow(), c.width && tinymce.DOM.setStyle(o.getEl(), "width", c.width), e.on("remove", function () {
            o.remove(), o = null
        }), i(o), {
