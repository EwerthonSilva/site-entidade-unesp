...
/* ================================================================================================================== */
/* DBO DEFINITION FILE FOR MODULE 'evento' ====================================== AUTO-CREATED ON 04/04/2016 15:08:49 */
/* ================================================================================================================== */
...
$button->custom = true;
$button->code = '
	$code = "<a target=\'_blank\' class=\'button tiny no-margin\' href=\'../allpharmajr/inscricoes.php?evento=".$id."\'>Formulário</a>";
';
$module->button[] = $button;
...
$button->custom = true;
$button->code = '
	$code = "<a target=\'_blank\' class=\'button tiny no-margin\' href=\'total-inscritos.php?evento=".$id."\'>Total de Inscritos</a>";
';
$module->button[] = $button;
