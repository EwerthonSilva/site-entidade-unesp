...
/* ================================================================================================================== */
/* DBO DEFINITION FILE FOR MODULE 'evento' ====================================== AUTO-CREATED ON 04/04/2016 15:09:18 */
/* ================================================================================================================== */
...
$button->custom = true;
$button->code = '
	$code = "<a target=\'_blank\' class=\'button tiny no-margin radius\' href=\'../allpharmajr/inscricoes.php?evento=".$id."\'>Formulário</a>";
';
$module->button[] = $button;
