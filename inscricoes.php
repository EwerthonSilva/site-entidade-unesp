...
<body style="<?= $bg ? 'background-image: url('.$bg.')' : '' ?>; ">
	<div class="row">
		<div class="container large-12 columns" style="padding: 15px 40px;">
			...
			<?php
			if((dboNow() >= $ev->data_insc_i) && (dboNow() <= $ev->data_insc_f)){
				...
				if($pal->size())
				{
					...
					<div class="row">
						<div class="large-12 columns">
							<p style="text-align: justify"><?= $ev->_descricao->html() ?></p>
							<p>
											...
											<div class="row">
												...
												<div id="forma-pagamento-input" class="large-4 columns">
													...
													<select name="forma_pagamento">
														...
														<?php
														//TODO MUDAR A DATA MANUAL PARA UMA VARIÁVEL DO MODULO DE ATIVIDADE
														if(dboNow('date') <= '2017-03-31'){
															echo '<option value="2x">2x</option>';
														}
														?>
											...
											<div class="row">
												...
												<div class="large-4 end columns">
													<label for="estado">CEP</label>
														<input type="text" name="cep" id="cep" value="" data-mask="99999-999" required/>
													</select>
												</div>
											</div>
											<div class="row">
					...
					<div class="row">
						<div class="large-12 columns text-center">
							<h4>
								O Evento selecionado está fora do período de inscrição.
							</h4>
						</div>
					</div>
					 <?php
